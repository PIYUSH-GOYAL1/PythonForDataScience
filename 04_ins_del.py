...
while (option_4 == "y"):
    ...
    print("1. Press 1 to insert elements in the list." )
    print("2. Press 2 to delete elements from the list.")
    ...
    if (option == 1):
        ...
        while (option_2 == 'y'):
            ...
            print("Press 'y' to continue inserting elements in the list or 'n' to finish. ")
            option_2 = input()
        print(list_1)
    ...
    print("Press 'y' to delete elements or 'n' to finish.")
    option_4 = input()
    print(list_1)
